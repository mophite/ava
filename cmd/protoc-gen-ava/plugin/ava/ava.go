...
const (
	avaServicePkgPath = "github.com/go-ava/ava"
)
...
// Name returns the name of this plugin, "github.com/go-ava/ava".
...
func (r *ava) generateService(file *generator.FileDescriptor, service *pb.ServiceDescriptorProto, index int) {
	...
	r.P("func New", serverName, "Client (c *", "ava.Client) ", serverName, "Client {")
	...
	r.P("func Register", serverName, "Server(s *ava.Server", ", h ", serverType, ") {")
